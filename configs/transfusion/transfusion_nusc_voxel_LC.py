...
train_pipeline = [
    ...
    dict(type='TransFusionLoadMultiViewImageFromFiles'),
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='TransFusionRandomFlip3D'),
            dict(type='MyResize', img_scale=img_scale, keep_ratio=True),
            dict(type='MyNormalize', **img_norm_cfg),
            # dict(type='MyPad', size_divisor=32),
            dict(
...
log_level = 'INFO'
work_dir = None
load_from = 'ckpts/centerpoint_0075voxel_second_secfpn_dcn_circlenms_4x8_cyclic_20e_nus_20210827_161135-1782af3e.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 8)
